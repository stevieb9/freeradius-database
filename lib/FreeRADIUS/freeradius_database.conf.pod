...
or name by enabling this setting.
...
Default: on ( for now. Please change it! )
...
across four BASs within the day because of modem resets, his daily
totals from all four BASs would be summed together and collectively
...
Currently, the classification is done via a regex-like check.
